            ...
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">
                  N°01 Train Street, <br /> El Yasminet, Ben Arous <br />
                  Tunisia
                </address>
                <a
                  href="tel:+216 40404040"
                  className="mt-3 d-block mb-1 text-white"
                >
                  +216 40404040
                </a>
                <a
                  href="mailto:info.techzone@techzone.com"
                  className="mt-2 d-block mb-0 text-white"
                >
                  info.techzone@techzone.com
                </a>
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}; Powered by GoMyCode
              </p>
            </div>
          </div>
        </div>
